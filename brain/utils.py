# -*- coding: utf-8 -*-
"""
Created on Sat Oct 24 16:19:55 2020
...
class SumTree(object):
    """
    This SumTree code was taken from the original code :
...
class Memory(object):  # stored as ( s, a, r, s_ ) in SumTree
    ...
    def sample(self, n):
        b_idx, memory_list, ISWeights = np.empty((n,), dtype=np.int32), [], np.empty((n, 1))
